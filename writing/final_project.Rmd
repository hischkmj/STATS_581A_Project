...
For the summary statistics, breweries were categorized by size. Since there are no industry standards for size, they were divided by quartiles in the dataset. Brewery sizes were small ($0 - $71370), mediume ($71371 - $143400), large ($143401 - $307722), and extra large ($307723 - inf).

```{r Summary Statistics & Graphics 1, fig.height=2.5, fig.width=4}
...
```{r Summary Statistics & Graphics 2, fig.height=2.5, fig.width=4}
ggplot() +
